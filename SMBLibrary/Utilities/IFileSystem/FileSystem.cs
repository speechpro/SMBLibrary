...
namespace Utilities
{
    public abstract class FileSystem : IFileSystem
    {
        ...
        public void CopyFile(string sourcePath, string destinationPath)
        {
            ...
            var sourceFile = GetEntry(sourcePath);
            var destinationFile = GetEntry(destinationPath);
            ...
            var sourceStream = OpenFile(sourcePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite, FileOptions.SequentialScan);
            var destinationStream = OpenFile(destinationPath, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite, FileOptions.None);
            while (sourceStream.Position < sourceStream.Length)
            {
                var readSize = (int)Math.Max(bufferLength, sourceStream.Length - sourceStream.Position);
