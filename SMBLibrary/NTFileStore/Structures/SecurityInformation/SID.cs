...
namespace SMBLibrary
{
    ...
    public class SID
    {
        ...
        public SID(Span<byte> buffer, int offset)
        {
            Revision = ByteReader.ReadByte(buffer, ref offset);
            var subAuthorityCount = ByteReader.ReadByte(buffer, ref offset);
            IdentifierAuthority = ByteReader.ReadBytes_RentArray(buffer, ref offset, 6);
        ...
        public void WriteBytes(Span<byte> buffer, ref int offset)
        {
            ...
            BufferWriter.WriteByte(buffer, ref offset, Revision);
            BufferWriter.WriteByte(buffer, ref offset, subAuthorityCount);
            BufferWriter.WriteBytes(buffer, ref offset, IdentifierAuthority, 6);
