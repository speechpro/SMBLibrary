...
namespace SMBLibrary
{
    ...
    /// </summary>
    public sealed class OwnBufferedStream : Stream
    {
        ...
        public OwnBufferedStream Init(Stream stream)
        {
            Init(stream, DefaultBufferSize);
            return this;
        }

        public OwnBufferedStream Init(Stream stream, int bufferSize)
        {
            CleanupInstance();
            if (stream == null)
        ...
        private void CleanupInstance()
        {
            ...
            _readPos = default;
            _writePos = default;
            _asyncActiveSemaphore = default;
            _lastSyncCompletedReadTask = default;
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            finally
            {
                ...
                CleanupInstance();
                ObjectsPool<OwnBufferedStream>.Return(this);
            }
        }
    ...
    public class SR
    {
        ...
        public static Exception Format(object argumentOutOfRangeMustBePositive, string bufferSizeName)
        {
            throw new NotImplementedException();
        }
    }
